...
${source
  .map((item, index) => {
    const cellDom = `<div class="handleGoNative"  data-key="goodsId,ownerId,activityType" data-goodsId=${
      ...
      item.ownerId
    } data-activityType="specialGoods" data-path="goods" data-linkType="inside" style="margin-bottom: ${
    ...
    <img src="${item.relateImg}" style="border-radius: 50%;width: ${vw(15)};height: ${vw(
      15,
    ...
    <div style="flex: 1">
    <div style="font-size: ${vw(16)}; margin-top: ${vw(
      15,
