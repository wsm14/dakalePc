...
// 修改电商品库存
const SeckillTimeRemainModal = (props) => {
  const { visible, dispatch, tableRef, onClose, loading } = props;
  const { show = false, detail = {} } = visible;
  const { payType, marketingSeckillId, ownerId, goodsId, goodsName, skuList } = detail;
...
export default connect(({ loading }) => ({
  loading: loading.effects['seckillTimeActivity/fetchSeckillTimeActivityGoodsEditRemain'],
