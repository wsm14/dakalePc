 ...
 * 视频权重设置
 */
const TradeSortSet = ({ detail, onSubmit, loading, getList }) => {
  const [form] = Form.useForm();
  const [editType, setEditType] = useState(false);

  const { categoryFrontId, sortValue: weight } = detail;
...
export default connect(({ loading }) => ({
  loading: loading.effects['sysTradeList/fetchFrontTradeSet'],
}))(TradeSortSet);
