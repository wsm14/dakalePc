...
const EditionModal = (props) => {
  ...
  const { configSpecialGoodsCategoryId } = detail;
  ...
  const handleOk = () => {
    form.validateFields().then((values) => {
      dispatch({
        type: {
          add: 'walkingManage/fetchSaveConfigSpecialGoodsCategory',
          edit: 'walkingManage/fetchUpdateConfigSpecialGoodsCategory',
        }[type],
        payload: {
          userOs: tabKey,
