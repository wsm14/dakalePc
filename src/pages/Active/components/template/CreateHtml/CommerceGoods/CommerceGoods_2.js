...
${source
  .map((item) => {
    ...
    const cellDom = `<div class="handleGoNative"  data-key="specialActivityId,ownerId" data-specialActivityId=${
      ...
      12,
    )}; color: #999999;">原价: <span style="text-decoration: line-through">¥${item.oriPrice}</span>
    </div>
    ${
      type === 'self'
        ? `<div style="lint-height: 1">
          <div style="margin-top:${vw(6)};font-size: ${vw(10)};border-radius: ${vw(
            2,
