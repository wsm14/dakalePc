...
const pathNative = {
  group: {
    ...
    dakaleAndroid: { path: 'DKLGroupMerchantDetailViewController', key: { id: 'merchantGroupId' } },
  ...
  merchant: {
    ...
    dakaleAndroid: { path: 'DKLShopDetailViewController', key: { id: 'shopId' } },
    miniProgram: { path: '/pages/perimeter/favourableDetails/index' },
  },
  goods: {
    // 特惠商品详情
