export default {
  active: ({ activityName, backgroundColor, head, body, footer }) => {
    ...
    <style>*{box-sizing:border-box;font-family: PingFang SC;}html{overflow-x: hidden;}html,body{background-color:${backgroundColor};width:100vw;height:100%;margin:0;padding:0;line-height: 1.15;-webkit-overflow-scrolling: touch;}</style>
    ${head}
    </head>
    <body>
    ${body}
