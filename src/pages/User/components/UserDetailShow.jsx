...
const UserDetailShow = (props) => {
  ...
  return {
    ...
    formItems: [
      ...
      { label: '个性签名', name: 's', render: (val) => val || '--' },
      ...
      { label: '常住地', name: 'creat2eTime', render: (val) => val || '--' },
      { label: '学校', name: 'creat2deTime', render: (val) => val || '--' },
      { label: '学历', name: 'creat2eTsime', render: (val) => val || '--' },
