...
const VideoPeasDetail = (props) => {
  ...
  const propItem = {
    ...
    dispatchType: 'videoPlatform/fetchShareGetBeanDetail',
...
export default connect(({ videoPlatform, baseData, loading }) => ({
  beanDetal: videoPlatform.beanDetal,
  userList: baseData.userList,
  loading: loading.effects['videoPlatform/fetchShareGetBeanDetail'],
}))(VideoPeasDetail);
