  ...
  return (
    <div key={field.key}>
      <Space className={styles.ifame_carouseal} align="baseline">
        <Form.Item name={[name, 'onlineGoodsDTO', 'goodsImg']} noStyle>
          <Upload maxFile={1} form={form} onChange={uploadVideo}></Upload>
        </Form.Item>
        <div>
          <Form.Item name={[name, 'onlineGoodsDTO', 'goodsName']} noStyle>
            <Input style={{ marginBottom: 24 }} placeholder="请输入商品名称" maxLength={20} />
          </Form.Item>
          <div>
            <Form.Item name={[name, 'onlineGoodsDTO', 'oriPrice']} noStyle>
